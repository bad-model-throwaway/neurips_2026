...
#SBATCH -o cluster/log/wk_summary_%j.out
#SBATCH -e cluster/log/wk_summary_%j.err
...
N_WORKERS=${SLURM_CPUS_PER_TASK} python -m simulations.sweep_walker_summary

echo "Done — summary_walker.pkl written to data/results/"
