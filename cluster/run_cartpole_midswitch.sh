...
#SBATCH -o cluster/log/cp_midswitch_%j.out
#SBATCH -e cluster/log/cp_midswitch_%j.err
...
N_WORKERS=${SLURM_CPUS_PER_TASK} python -m simulations.sweep_cartpole_midswitch

echo "Done — midswitch_cartpole.pkl written to data/results/"
